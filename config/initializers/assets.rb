...
Rails.application.config.assets.precompile += %w( backgrounds/*)
Rails.application.config.assets.precompile += %w( modal/*)
Rails.application.config.assets.precompile += %w( team/*)
Rails.application.config.assets.precompile += %w( testimonials/*)
